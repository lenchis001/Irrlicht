...
namespace scene
{
	...
	public:
		...
		CTerrainSceneNode(boost::shared_ptr<ISceneNode> parent, boost::shared_ptr<scene::ISceneManager> mgr, boost::shared_ptr<io::IFileSystem> fs, s32 id,
		...
		virtual boost::shared_ptr<ISceneNode> clone(boost::shared_ptr<ISceneNode> newParent,
				boost::shared_ptr<scene::ISceneManager> newManager);
