	...
	ExternalWindow(false), AutorepeatSupport(0)
{
	...
	Operator = boost::make_shared<COSOperator>(linuxversion, this);
	...
	CursorControl = boost::make_shared<CCursorControl>(this, CreationParams.DriverType == video::EDT_NULL);
...
CIrrDeviceLinux::~CIrrDeviceLinux()
{
	...
	if (CursorControl)
	{
		...
		boost::static_pointer_cast<CCursorControl>(CursorControl)->clearCursors();
	}
