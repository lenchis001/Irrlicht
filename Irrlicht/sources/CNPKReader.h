...
namespace io
{
	...
	public:
		...
		//! Constructor
		CArchiveLoaderNPK(boost::shared_ptr<io::IFileSystem> fs);
	...
	//! reads from NPK
	class CNPKReader : public virtual IFileArchive, public virtual CFileList, public SharedThisMixin<CNPKReader>
	{
	public:

		CNPKReader(boost::shared_ptr<IReadFile> file, bool ignoreCase, bool ignorePaths);
		virtual ~CNPKReader();
