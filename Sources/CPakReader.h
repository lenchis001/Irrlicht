...
namespace io
{
	...
	//! reads from pak
	class CPakReader : public virtual IFileArchive, public virtual CFileList, public SharedThisMixin<CPakReader>
	{
	public:

		CPakReader(boost::shared_ptr<IReadFile> file, bool ignoreCase, bool ignorePaths);
		virtual ~CPakReader();
