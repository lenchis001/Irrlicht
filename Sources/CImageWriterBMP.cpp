...
{
	return boost::make_shared<CImageWriterBMP>();
}
...
bool CImageWriterBMP::writeImage(boost::shared_ptr<io::IWriteFile> file, boost::shared_ptr<IImage> image, u32 param) const
{
